...
SELECT * FROM ema.METADATA;

INSERT INTO `ema`.`ESB_MESSAGE`
(`id`, `error_component`, `error_details`, `error_message`, `error_queue`, `error_system`, `error_type`, `message_guid`, `jms_message_id`, `message_type`, `occurrence_count`, `payload`, `service_name`, `source_location`, `source_queue`, `source_system`, `jms_message_timestamp`)
VALUES
(
1,
'GitHubOrgCreate',
'There was a problem syncing your GitHub organization',
'That organization already exsits',
'GITHUB_ORG_ERROR',
'GitHub',
'DATA_ERROR',
'8675309',
...
'XML',
1,
'<GitHubOrganization><OrganizationName>esbtools</OrganizationName><BillingEmail>admin@esbtools.org</BillingEmail><OrganizationsPlan>Open Source</OrganizationsPlan><Visibility>Public</Visibility></GitHubOrganization>',
'GitHub',
'Internet',
'GITHUB_ORG_CREATE',
'GitHub',
...
2,
'GitHubOrgSync',
'There was a problem syncing your GitHub repository',
...
'XML',
1,
'<GitHubOrganization> <OrganizationName>lightblue-platform</OrganizationName> <BillingEmail>admin@lightblue.io</BillingEmail> <OrganizationsPlan>Open Source</OrganizationsPlan><Visibility>Public</Visibility></GitHubOrganization>',
'GitHub',
'Internet',
'GITHUB_REPO_SYNC',
'GitHub',
...
3,
'GitHubOrgReaper',
'There was a problem deleting your GitHub repository',
'Your repository could not be deleted, child projects still exist',
'GITHUB_REPO_ERROR',
'GitHub',
'DATA_ERROR',
'7184981043',
...
'XML',
1,
'<GitHubOrganization> <OrganizationName>darcy-framework</OrganizationName> <BillingEmail>admin@darcyframework.org</BillingEmail> <OrganizationsPlan>Open Source</OrganizationsPlan><Visibility>Public</Visibility></GitHubOrganization>',
'GitHub',
'Internet',
'GITHUB_REPO_REAP',
'GitHub',
...
4,
'GitHubRepoCreator',
'There was a problem creating your GitHub repository',
'Your repository could not be created',
'GITHUB_REPO_ERROR',
'GitHub',
'DATA_ERROR',
'3016968699',
...
'XML',
1,
'<GitHubOrganization> <OrganizationName>lightblue-platform</OrganizationName> <BillingEmail>admin@lightblue.io</BillingEmail> <OrganizationsPlan>Open Source</OrganizationsPlan> </GitHubOrganization>',
'GitHub',
'Internet',
'GITHUB_REPO_CREATE',
'GitHub',
...
'XML',
1,
'<GitHubRespository> <Owner>esbtools</Owner> <RepositoryName>esbtools.github.io</RepositoryName> <Description>GitHub Pages project for esbtools</Description> <Visibility>Public</Visibility> <InitializeWithReadMe>true</InitializeWithReadMe> <GitIgnores> <GitIgnore> /target </GitIgnore> </GitIgnores> <License>GNU General Public License v3.0</License> </GitHubRespository>',
'GitHub',
'Internet',
'GITHUB_REPO_CREATE',
'GitHub',
...
'XML',
1,
'<GitHubRespository> <Owner>lightblue-platform</Owner> <RepositoryName>lightblue</RepositoryName> <Description>Submodules repo that brings together all source for lightblue-platform in one place.</Description> <Visibility>Public</Visibility> <InitializeWithReadMe>true</InitializeWithReadMe> <GitIgnores> <GitIgnore> /target </GitIgnore> </GitIgnores> <License>GNU General Public License v3.0</License> </GitHubRespository>',
'GitHub',
'Internet',
'GITHUB_REPO_CREATE',
'GitHub',
...
'XML',
1,
'<GitHubRespository> <Owner>lightblue-applications</Owner> <RepositoryName>lightblue</RepositoryName> <Description>Web applications for managing data in lightblue</Description> <Visibility>Public</Visibility> <InitializeWithReadMe>true</InitializeWithReadMe> <GitIgnores> <GitIgnore> /target </GitIgnore> </GitIgnores> <License>GNU General Public License v3.0</License> </GitHubRespository>',
'GitHub',
'Internet',
'GITHUB_REPO_CREATE',
'GitHub',
...
'XML',
1,
'<GitHubRespository> <Owner>lightblue-client</Owner> <RepositoryName>lightblue</RepositoryName> <Description>Client for interacting with lightblue services</Description> <Visibility>Public</Visibility> <InitializeWithReadMe>true</InitializeWithReadMe> <GitIgnores> <GitIgnore> /target </GitIgnore> </GitIgnores> <License>GNU General Public License v3.0</License> </GitHubRespository>',
'GitHub',
'Internet',
'GITHUB_REPO_CREATE',
'GitHub',
...
10,
'GitHubUserCreator',
'There was a problem creating your GitHub user',
...
'XML',
1,
'<GitHubUser> <Login>derek63</Login> <Name>Derek</Name> <Location>Berlin, Germany</Location> <TimeZone>GMT+1</TimeZone> </GitHubUser>',
'GitHub',
'Internet',
'GITHUB_USER_CREATE',
'GitHub',
...
SELECT * FROM ema.ESB_MESSAGE;

TRUNCATE TABLE ema.ESB_MESSAGE_HEADER;

INSERT INTO `ema`.`ESB_MESSAGE_HEADER`
(`name`, `type`, `value`, `message_id`)
VALUES
(
'name',
'METADATA',
...
SELECT * FROM ema.ESB_MESSAGE_HEADER;