describe('SyncKeysCtrl and SearchKeysCtrl', function() {
    ...
    var syncKeysCtrl, searchKeysCtrl, rootScope;
    ...
    function manageChildrenTest(scope, response) {
        ...
        expect(scope.parent)
                .toEqual(response.data.tree.children[0].children[0]);
    }

    it('add tests', function() {
        addTest(syncKeysScope, syncKeysSuccessResponse, "testName", "Entity",
                "testValue");
        addTest(searchKeysScope, searchKeysSuccessResponse, "SearchKeys",
                "SearchKey", "testValue");
    });
    ...
    it('update tests', function() {
        updateTests(syncKeysScope, syncKeysSuccessResponse, "testName",
                "Entity", "testValue");
        updateTests(searchKeysScope, searchKeysSuccessResponse, "SearchKey",
                "SearchKey", "testValue");
    });
